...
export async function applyDecay() {
    ...
    try {
        ...
        const decayResult = await db
            ...
            .where(and(lt(memoryShortTerm.createdAt, sevenDaysAgo), eq(memoryShortTerm.promoted, false)))
        ...
        const deleteResult = await db
            ...
            .where(and(lt(memoryShortTerm.importance, 0.1), eq(memoryShortTerm.promoted, false)))
            .returning({ id: memoryShortTerm.id });
