...
function getUserEventChannel(userId) {
...
export function emitEvent(userId, channel, type, data) {
    const message = {
...
export function emitUserEvent(userId, type, data) {
...
export function registerSseRoute(app) {
    app.get('/api/v1/events/stream', async (req, res) => {
        ...
        const onMessage = (_channel, message) => {
            ...
            const eventChannel = typeof parsedMessage.channel === 'string'
